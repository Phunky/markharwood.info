...
ARG PUBLIC_NOW_LAST_UPDATED
ARG PUBLIC_USES_LAST_UPDATED
ENV PUBLIC_LASTFM_API_KEY=$PUBLIC_LASTFM_API_KEY
ENV PUBLIC_LASTFM_USER=$PUBLIC_LASTFM_USER
ENV PUBLIC_NOW_LAST_UPDATED=$PUBLIC_NOW_LAST_UPDATED
ENV PUBLIC_USES_LAST_UPDATED=$PUBLIC_USES_LAST_UPDATED
